...
WebUI.selectOptionByValue(findTestObject('Page_MakeAppointment/select_Facility'), 'Hongkong CURA Healthcare Center', true)
...
WebUI.setText(findTestObject('Page_MakeAppointment/textarea_Comment'), 'lalal')
